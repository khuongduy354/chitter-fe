    ...
    <div style={{ overflowY: "scroll", overflowX: "hidden" }}>
      ...
      <ul style={{ listStyle: "none" }}>
        {messages.map((msg, idx) => {
          // const isMyMsg = msg.from === user.id; // TODO : repadding the position
                ...
                <span
                  style={{
                    backgroundColor: theme
                      ? applyTheme(true).backgroundColor
                      : "blue",
                    padding: 10,
                    borderRadius: 20,
                    color: theme ? applyTheme(true).textColor : "white",
                    margin: 5,
                  }}
                >
                  {msg.content}
...
export const PublicChatPanel = ({ username }) => {
  ...
  useEffect(() => {
    // if (!user) return; TODO: unlock after user
    // load chat msgs
    ...
    <div>
      ...
      {!themePicker && (
        <Flex
          ...
          style={{ height: "90vh", background: "grey", padding: "5px" }}
        >
